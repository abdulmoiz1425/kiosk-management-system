...
if _DB_ENGINE == 'mysql':
    ...
    DATABASES = {
        'default': {
            ...
            'NAME': config('DB_NAME', default='wafaatech_db'),
...
# NAS storage path (falls back to local media for development)
NAS_MOUNT_PATH = config('NAS_MOUNT_PATH', default=str(BASE_DIR / 'media'))
